...
export const dashboard = createAsyncThunk(
  ...
  async (role: string) => await backendAPI.dashboard(role)
);
export const get = createAsyncThunk(
  ...
  async (params: {
    ...
    show?: number | string;
    search?: string;
  }) => await backendAPI.get(params)(params.page, params.show, params.search)
);
export const info = createAsyncThunk(
  "backend/manager/info",
  async (params: { role: string; resource: string }) =>
    await backendAPI.info(params)()
);
export const show = createAsyncThunk(
  "backend/manager/show",
  async (params: { role: string; resource: string; id: string }) =>
    await backendAPI.show(params)(params.id)
);
export const post = createAsyncThunk(
  "backend/manager/post",
  async (params: { role: string; resource: string; data: any }) =>
    await backendAPI.post(params)(params.data)
);
export const patch = createAsyncThunk(
  "backend/manager/patch",
  async (params: { role: string; resource: string; id: string; data: any }) =>
    await backendAPI.patch(params)(params.id, params.data)
);
export const _delete = createAsyncThunk(
  "backend/manager/delete",
  async (params: { role: string; resource: string; id: string }) =>
    await backendAPI.delete(params)(params.id)
);
...
const dataFulfilled = (
  state: BackendState,
  action: PayloadAction<ApiBackendDataType>
) => {
  if (action.payload) {
